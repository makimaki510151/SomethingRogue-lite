execute store result score temp1 system run clear @s leather[custom_data={material_id:stage_1_zako_2}] 0
execute store result score temp2 system run clear @s netherite_scrap[custom_data={material_id:stage_1_boss_2}] 0
