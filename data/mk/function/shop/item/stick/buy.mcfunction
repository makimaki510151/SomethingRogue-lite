...
execute store result storage mk:item attack_damage_p float 1 run scoreboard players get attack_damage_p system
...
scoreboard players operation attack_speed_p system /= 3 const
execute store result storage mk:item attack_speed float 0.01 run scoreboard players get attack_speed system
execute store result storage mk:item attack_speed_p float 1 run scoreboard players get attack_speed_p system
